...
/**
 * @description The identifier to pass CoinGecko Pro API Key
 * @kind constant
 */
const PRO_API_KEY_IDENTIFIER = 'x_cg_pro_api_key'

/**
 * @description The host of the CoinGecko Pro API
 * @kind constant
 */
...
/**
 * @description Timeout for connecton to CoinGecko API in milliseconds
 * @kind constant
 */
const TIMEOUT = 10000;
